...
class TestControllerWebTest {
    ...
    void updateInvallid() throws Exception {
        ...
        //given
        given(taskService.updateTask(NOT_FOUND_TASK_ID, UPDATE_TASK_TITLE)).willThrow(TaskNotFoundException.class);
    ...
    void deleteInvalid() throws Exception {
        ...
        //given
        given(taskService.removeTask(NOT_FOUND_TASK_ID)).willThrow(TaskNotFoundException.class);
